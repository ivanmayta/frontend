"use server"
import zod from "zod"
import { loginUserService, registerUserService } from "../auth/auth-service"
...
export async function registerUserAction(prevState: any, formData: FormData) {
    ...
    const fields = userRegistrationSchema.safeParse({
    ...
    const responseData = await registerUserService(fields.data)
    if (!responseData) {
        return {
            ...prevState,
            zodErrors: null,
