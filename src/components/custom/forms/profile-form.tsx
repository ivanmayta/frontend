...
import { updateProfileAction } from "@/services/actions/profile-action"
...
export function ProfileForm({
    ...
    const updateProfileActionWithId = updateProfileAction.bind(null, data.id)
    const [formState, formAction] = useActionState(
        updateProfileActionWithId,
        INITIAL_STATE
    )
    // console.log("## will render on client: profile##")
